...
print("ROKU FULL SITE SEO QUERIES - https://www.roku.com/")  
  ...
  try(colnames(roku.seo.full)[1] <- "EVENT_TS")
  ...
  try(colnames(roku.seo.page)[1] <- "EVENT_TS")
  ...
  try(colnames(roku.seo.query)[1] <- "EVENT_TS")
  
  
  roku.seo.full <-
    cbind(SITE = "Main", roku.seo.full)
  roku.seo.full <- try(roku.seo.full[,c(2,1,3:11)])

  roku.seo.page <-
    cbind(SITE = "Main", roku.seo.page)
  roku.seo.page <- try(roku.seo.page[,c(2,1,3:10)])
  
  roku.seo.query <-
    cbind(SITE = "Main", roku.seo.query)
  roku.seo.query <- try(roku.seo.query[,c(2,1,3:10)])
...
print("ROKU SUPPORT SECURED SITE SEO QUERIES - https://support.roku.com/")
  ...
  try(colnames(roku.seo.full.supsec)[1] <- "EVENT_TS")
  ...
  try(colnames(roku.seo.page.supsec)[1] <- "EVENT_TS")
  ...
  try(colnames(roku.seo.query.supsec)[1] <- "EVENT_TS")
  
  
  roku.seo.full.supsec <-
    cbind(SITE = "Support Secured", roku.seo.full.supsec)
  roku.seo.full.supsec <- try(roku.seo.full.supsec[,c(2,1,3:11)])
  
  roku.seo.page.supsec <-
    cbind(SITE = "Support Secured", roku.seo.page.supsec)
  roku.seo.page.supsec <- try(roku.seo.page.supsec[,c(2,1,3:10)])

  roku.seo.query.supsec <-
    cbind(SITE = "Support Secured", roku.seo.query.supsec)
  roku.seo.query.supsec <- try(roku.seo.query.supsec[,c(2,1,3:10)])
...
# NOT USED ROKU SUPPORT NON-SECURED SITE SEO QUERIES - http://support.roku.com/ ----------------
...
#         F, dimensionFilterExp = "country==USA"
#     )
#   try(colnames(roku.seo.full.supnon)[1] <- "EVENT_TS")
#   
#   
...
#         F, dimensionFilterExp = "country==USA"
#     )
#   try(colnames(roku.seo.page.supnon)[1] <- "EVENT_TS")
#   
#   
...
#         F, dimensionFilterExp = "country==USA"
#     )
#   try(colnames(roku.seo.query.supnon)[1] <- "EVENT_TS")
#   
#   
#   roku.seo.full.supnon <-
#     cbind(SITE = "Support Non-Secured", roku.seo.full.supnon)
#   roku.seo.full.supnon <- try(roku.seo.full.supnon[,c(2,1,3:11)])
#   
#   roku.seo.page.supnon <-
#     cbind(SITE = "Support Non-Secured", roku.seo.page.supnon)
#   roku.seo.page.supnon <- try(roku.seo.page.supnon[,c(2,1,3:10)])
#   
#   roku.seo.query.supnon <-
#     cbind(SITE = "Support Non-Secured", roku.seo.query.supnon)
#   roku.seo.query.supnon <- try(roku.seo.query.supnon[,c(2,1,3:10)])
# 
#   
#   
#   full.supnon.file <-
...
print("ROKU MY SITE SEO QUERIES - https://my.roku.com/")
  ...
  try(colnames(roku.seo.full.my)[1] <- "EVENT_TS")
  ...
  try(colnames(roku.seo.page.my)[1] <- "EVENT_TS")
  ...
  try(colnames(roku.seo.query.my)[1] <- "EVENT_TS")
  
  
  roku.seo.full.my <-
    cbind(SITE = "My", roku.seo.full.my)
  roku.seo.full.my <- try(roku.seo.full.my[,c(2,1,3:11)])

  roku.seo.page.my <-
    cbind(SITE = "My", roku.seo.page.my)
  roku.seo.page.my <- try(roku.seo.page.my[,c(2,1,3:10)])

  roku.seo.query.my <-
    cbind(SITE = "My", roku.seo.query.my)
  roku.seo.query.my <- try(roku.seo.query.my[,c(2,1,3:10)])
...
print("ROKU FORUMS SITE SEO QUERIES - http://forums.roku.com/")
  ...
  try(colnames(roku.seo.full.forum)[1] <- "EVENT_TS")
  ...
  try(colnames(roku.seo.page.forum)[1] <- "EVENT_TS")
  ...
  try(colnames(roku.seo.query.forum)[1] <- "EVENT_TS")
  
  
  roku.seo.full.forum <-
    cbind(SITE = "Forum", roku.seo.full.forum)
  roku.seo.full.forum <- try(roku.seo.full.forum[,c(2,1,3:11)])

  roku.seo.page.forum <-
    cbind(SITE = "Forum", roku.seo.page.forum)
  roku.seo.page.forum <- try(roku.seo.page.forum[,c(2,1,3:10)])

  roku.seo.query.forum <-
    cbind(SITE = "Forum", roku.seo.query.forum)
  roku.seo.query.forum <- try(roku.seo.query.forum[,c(2,1,3:10)])
...
print("ROKU BLOG SITE SEO QUERIES - https://blog.roku.com/")
  ...
  try(colnames(roku.seo.full.blog)[1] <- "EVENT_TS")
  ...
  try(colnames(roku.seo.page.blog)[1] <- "EVENT_TS")
  ...
  try(colnames(roku.seo.query.blog)[1] <- "EVENT_TS")
  
  
  roku.seo.full.blog <-
    cbind(SITE = "Blog", roku.seo.full.blog)
  roku.seo.full.blog <- try(roku.seo.full.blog[,c(2,1,3:11)])

  roku.seo.page.blog <-
    cbind(SITE = "Blog", roku.seo.page.blog)
  roku.seo.page.blog <- try(roku.seo.page.blog[,c(2,1,3:10)])

  roku.seo.query.blog <-
    cbind(SITE = "Blog", roku.seo.query.blog)
  roku.seo.query.blog <- try(roku.seo.query.blog[,c(2,1,3:10)])
...
print("ROKU CHANNEL STORE SITE SEO QUERIES - https://channelstore.roku.com/")
  ...
  try(colnames(roku.seo.full.channel)[1] <- "EVENT_TS")
  ...
  try(colnames(roku.seo.page.channel)[1] <- "EVENT_TS")
  ...
  try(colnames(roku.seo.query.channel)[1] <- "EVENT_TS")
  
  
  roku.seo.full.channel <-
    cbind(SITE = "Channel", roku.seo.full.channel)
  roku.seo.full.channel <- try(roku.seo.full.channel[,c(2,1,3:11)])

  roku.seo.page.channel <-
    cbind(SITE = "Channel", roku.seo.page.channel)
  roku.seo.page.channel <- try(roku.seo.page.channel[,c(2,1,3:10)])

  roku.seo.query.channel <-
    cbind(SITE = "Channel", roku.seo.query.channel)
  roku.seo.query.channel <- try(roku.seo.query.channel[,c(2,1,3:10)])
...
print("STRAIGHTALK BRAND SEO QUERIES  - https://www.straighttalk.com/") 
  ...
  try(colnames(st.seo.full.main)[1] <- "EVENT_TS")
  ...
  try(colnames(st.seo.page.main)[1] <- "EVENT_TS")
  ...
  try(colnames(st.seo.query.main)[1] <- "EVENT_TS")
  
  
  st.seo.full.main <-
    cbind(SITE = "Main", st.seo.full.main)
  st.seo.full.main <- try(st.seo.full.main[,c(2,1,3:11)])
  
  st.seo.page.main <-
    cbind(SITE = "Main", st.seo.page.main)
  st.seo.page.main <- try(st.seo.page.main[,c(2,1,3:10)])
  
  st.seo.query.main <-
    cbind(SITE = "Main", st.seo.query.main)
  st.seo.query.main <- try(st.seo.query.main[,c(2,1,3:10)])
...
print("TRACFONE BRAND SEO QUERIES  - http://www.tracfone.com/")  
  ...
  try(colnames(tf.seo.full.main)[1] <- "EVENT_TS")
  ...
  try(colnames(tf.seo.page.main)[1] <- "EVENT_TS")
  ...
  try(colnames(tf.seo.query.main)[1] <- "EVENT_TS")
  
  
  tf.seo.full.main <-
    cbind(SITE = "Main", tf.seo.full.main)
  tf.seo.full.main <- try(tf.seo.full.main[,c(2,1,3:11)])
  
  tf.seo.page.main <-
    cbind(SITE = "Main", tf.seo.page.main)
  tf.seo.page.main <- try(tf.seo.page.main[,c(2,1,3:10)])
  
  tf.seo.query.main <-
    cbind(SITE = "Main", tf.seo.query.main)
  tf.seo.query.main <- try(tf.seo.query.main[,c(2,1,3:10)])
...
print("TOTAL WIRELESS BRAND SEO QUERIES  - https://www.totalwireless.com/")  
  ...
  try(colnames(tw.seo.full.main)[1] <- "EVENT_TS")
  ...
  try(colnames(tw.seo.page.main)[1] <- "EVENT_TS")
  ...
  try(colnames(tw.seo.query.main)[1] <- "EVENT_TS")
  
  
  tw.seo.full.main <-
    cbind(SITE = "Main", tw.seo.full.main)
  tw.seo.full.main <- try(tw.seo.full.main[,c(2,1,3:11)])
  
  tw.seo.page.main <-
    cbind(SITE = "Main", tw.seo.page.main)
  tw.seo.page.main <- try(tw.seo.page.main[,c(2,1,3:10)])
  
  tw.seo.query.main <-
    cbind(SITE = "Main", tw.seo.query.main)
  tw.seo.query.main <- try(tw.seo.query.main[,c(2,1,3:10)])
...
print("NET10 BRAND SEO QUERIES  - http://www.net10wireless.com/ + http://www.net10.com/ ")  
