# need to do:
# define association rule, support, confidence, lift, sparse binary matrix
# take shot of p44 receipt for "market basket"

# Remember to tell them to install the package
# install.packages("arules")
# install.packages("arulesViz")

setwd("C:\\Users\\jvangeete\\Google Drive\\School\\UCD\\Applied Stats")
...
print((Groceries)[1])  # 9835 market baskets for shopping trips
print((Groceries)[2])  # 169 initial store items  
